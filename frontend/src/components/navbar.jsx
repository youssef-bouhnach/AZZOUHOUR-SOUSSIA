...
import { Leaf, User, Heart, ShoppingBag, Search, X, Menu, LogOut, Package, Settings } from "lucide-react";
...
function Navbar() {
  ...
  useEffect(() => {
    const onKey = (e) => {
      if (e.key === "Escape") { setSearchOpen(false); setShopOpen(false); setProfileOpen(false); }
    };
