...
const normalizePayment = (status) => {
  if (status === "collected_by_deliveryman" || status === "paid") return "paid";
    ...
    <>
      ...
      <div className="order_panel">
        ...
        <div className="order_panel_badges">
          ...
          <Badge value={normalizePayment(order.payment_status)} map={PAYMENT_COLORS} />
        </div>
                ...
                <tbody>
                  {orders.map((order) => (
                    <tr key={order.id} className="orders_row">
                      ...
                      <td><Badge value={normalizePayment(order.payment_status)} map={PAYMENT_COLORS} /></td>
                      <td>
                        <button
